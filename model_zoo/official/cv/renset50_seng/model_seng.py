...
class Model_SENG(Model):
    ...
    def __init__(self, network, loss_fn=None, optimizer=None, metrics=None, eval_network=None,
        ...
        super(Model_SENG, self).__init__(network, loss_fn, optimizer, metrics, eval_network,
    ...
    def _train_dataset_sink_process(self, epoch, train_dataset, list_callback=None, cb_params=None, sink_size=-1):
        ...
        train_dataset.__loop_size__ = 1 #added by xudong  (also in model.py)
        ...
        for i in range(epoch):
            ...
            # for data sink dataset_helper only iter once, otherwise iter epoch_size times.
                ...
                if context.get_context("device_target") == "GPU":
                    if switch_branch_one:
                        ...
                        if train_network_init_flag:
                            self._train_network.add_flags_recursive(seng=True)
                        ...
                        cb_params.cur_step_num += 1
                        if train_network_init_flag:
                            self._train_network.add_flags_recursive(seng=False)
